...
objective = 2 * num_product1 + 5 * num_product2
problem += objective

# Define the constraints
problem += 3 * num_product1 + 6 * num_product2 <= 120
problem += 10 * num_product1 + 20 * num_product2 <= 200
...
# Output the answer
print("## start solving")
print("The number of units of product 1 to produce:", value(num_product1))
print("The number of units of product 2 to produce:", value(num_product2))
